...
export default function Booking() {
    ...
    useEffect(() => {
        getRooms().then(setFilteredRooms);
    }, []);
    ...
    const filterClick = () =>
        filterRoom(selectedRoomName, guest.Children, guest.Adult, range[0].startDate, range[0].endDate).then(setFilteredRooms);
        ...
        <>
            ...
            <div className="bg-[rgb(250,247,245)] mx-auto container py-5 ">
                ...
                <div className=" grid grid-cols-12 ">
                    ...
                    <Button type="submit" onClick={filterClick} className="!bg-rose-500 h-10 !text-white">Filter</Button>
                </div>
                        ...
                        <div key={room.id} className="border border-none bg-white p-10 rounded-md">
                            <div className="grid grid-cols-12 gap-10">
                                <div className="col-span-3 mt-10">
                                    <RoomSlider images={room.imageURls} alt={room.roomName} />
                                </div>
